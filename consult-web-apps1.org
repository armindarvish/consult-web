...
#+RESULTS:
: consult-web-apps-format-linux-app
...
#+RESULTS:
: consult-web--apps-list-linux-desktop-entries

****** parse single desktop entry
#+begin_src emacs-lisp
...
#+RESULTS:
: consult-web--apps-linux-parse-desktop-entry

****** parse list of desktop entries
#+begin_src emacs-lisp
...
`counsel-linux-apps-faulty'."
  (let (result)
    ...
    (dolist (entry entries result)
      (let* ((r (consult-web--apps-linux-parse-desktop-entry entry)))
        (when r
          (push r result))))))
#+end_src

****** get list of linux desktop apps
#+begin_src emacs-lisp

...
***** static collect static sync candidates
#+begin_src emacs-lisp
...
***** static collect static dynamic candidates
#+begin_src emacs-lisp
...
***** static collect static async candidates
#+begin_src emacs-lisp
...
#+RESULTS:
: consult-web--multi-candidates-static
...
#+RESULTS:
: consult-web--youtube-fetch-channel-details
...
#+RESULTS:
: consult-web--youtube-fetch-results

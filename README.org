...
*Note* that the video above uses an eralier version of the package. Here is another video that explains some of the changes:
...
*** Minimal Code Base
Without docstrings and whitespaces the code is less than 1000 lines and it only depends on [[https://github.com/minad/consult][consult]] and built-in url-retrieve.
